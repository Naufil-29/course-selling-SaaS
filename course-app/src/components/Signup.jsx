...
export default function SignUp({ closeSignup, openSignin }) {
  ...
  return (
    <div className="main fixed inset-0 z-50 w-screen h-screen bg-black/30 backdrop-blur-sm flex items-center justify-center p-4 overflow-y-auto">
      {loading && (
        ...
        <div className="form-section w-full md:w-1/2 flex flex-col overflow-y-auto">
          ...
          <div className="form-content flex-1 p-4 md:p-6 lg:p-8">
            ...
            <div className="form-input flex flex-col gap-4">
              ...
              />
              <div onClick={signup} className="w-full">
                <Button
                  loading={loading}
